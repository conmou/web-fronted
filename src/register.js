...
function Register() {
  ...
  return (
              ...
              <div className="mx-auto w-full max-w-xl">
                <div>
                  <img
                    ...
                    alt="Your Company"
                  />
                  <h2 className="mt-8 text-2xl font-bold text-center leading-9 tracking-tight text-gray-900">
                    創建你得帳號
                  </h2>
                  ...
                  <div>
                    ...
                    <div>
                     ...
                     <div className="mt-2">
                      ...
                      />
                      {/* {errors.name && <span class="text-red"> { errors.name } </span>} */}
                    </div>
                  </div>
    ...
    //               {/* <div>
    //                 <label htmlFor="check_password" className="block text-sm font-medium leading-6 text-gray-900">
    //                   確認密碼
    //                 </label>
    //                 <div className="mt-2">
    //                   <input
    ...
    //                     autoComplete="current-password"
    //                     required
    //                     className="block w-full rounded-md border-0 px-1.5 y-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
    //                   />
    //                 </div>
    //               </div> */}
